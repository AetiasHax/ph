...
public:
    ...
    static void func_ov00_02083a1c(unk8 *param_1, MapManager *param_2, Vec3p *param_3);
    static unk8 func_ov00_02083a54(u8 *param_1, MapManager *param_2, s32 *param_3, u8 param_4, u8 param_5);
