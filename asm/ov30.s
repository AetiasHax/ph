...
func_ov30_0217d054: ; 0x0217d054
	stmdb sp!, {r3, lr}
	ldr r0, _0217d094 ; =gActorManager
	mov r1, r2
	ldr r0, [r0]
...
_0217ec2c:
	...
	blo _0217ec2c
	ldr r1, [r4, #8]
	ldr r0, _0217ecec ; =gActorManager
	str r1, [sp, #8]
	ldr r5, [r4, #0xc]
	add r3, sp, #8
	ldr r0, [r0]
	...
	cmp r0, #0
	ble _0217eccc
	ldr r8, _0217ecec ; =gActorManager
	mov r6, r5
_0217ec8c:
	ldr r1, [sp, #0x18]
	ldr r0, [r8]
...
_0217f3b8:
	...
	ldr r8, _0217f560 ; =gActorManager
	add r10, sp, #0x50
	add r4, sp, #0
_0217f3e0:
	ldr r0, [r9]
...
_02180f1a:
	...
	blt _02181016
	add r0, r4, #0
	blx _ZN5Actor18func_ov00_020c3158Ev
	ldrh r0, [r4, #0x22]
	cmp r0, #5
	bhi _02180fe6
	add r0, r0, r0
...
func_ov30_021818b8: ; 0x021818b8
	...
	ldr r1, _021819e0 ; =gActorManager
	...
	cmp r1, r0
	beq _02181944
	ldr r0, _021819e0 ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	add r1, sp, #0x34
...
_02181944:
	ldr r7, _021819e0 ; =gActorManager
	mov r4, #0
	add r10, sp, #0
	add r8, sp, #0x10
	add r11, sp, #0x44
...
_021825a0:
	bl func_ov00_02081f4c
	ldr r1, _0218262c ; =gActorManager
	...
	cmp r1, r0
	beq _02182618
	ldr r0, _0218262c ; =gActorManager
	add r1, sp, #0x14
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	add r1, sp, #0x24
...
func_ov30_02182634: ; 0x02182634
	...
	mov r1, r4
	add r2, r4, #0x860
	bl _ZN5Actor18func_ov00_020c23d4EP8ActorRefPS_P8Cylinder
	mov r2, #0
	add r0, sp, #0x114
...
_0218271c:
	...
	cmp r5, r0
	blo _0218271c
	ldr r0, _02182ac4 ; =gActorManager
	mov r3, #0
	ldr r0, [r0]
	add r6, sp, #0x74
	mov r5, #0x10
	...
	cmp r0, #0
	ble _021827d4
	ldr r7, _02182ac4 ; =gActorManager
	mov r6, r5
	add r8, sp, #0x58
_02182778:
	ldr r1, [sp, #0x68]
...
_021830c8:
	...
	ldr r0, _02183220 ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
_021832a8:
	...
	add r2, r4, #0x48
	bl func_ov00_020c4048
	ldr r0, _021833e0 ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
_021834e0:
	...
	cmp r7, r0
	blo _021834e0
	ldr r0, _0218380c ; =gActorManager
	add r1, sp, #0x274
	ldr r0, [r0]
	add r2, sp, #0x1e8
	bl _ZN12ActorManager12FilterActorsEP15ActorFilterBaseP9ActorList
	...
	cmp r0, #0
	ble _0218358c
	ldr r9, _0218380c ; =gActorManager
	mov r8, r7
	add r5, sp, #0
_02183524:
	ldr r1, [sp, #0x1e8]
...
_02183788:
	...
	mov r5, #0
	ble _021837f4
	ldr r7, _0218380c ; =gActorManager
	add r8, sp, #0
_0218379c:
	ldr r0, [r7]
	mov r1, r8
...
func_ov30_02183818: ; 0x02183818
	stmdb sp!, {r4, r5, r6, lr}
	ldr r2, _021838f4 ; =gActorManager
	mov r5, r0
	add r1, r5, #0x84
	ldr r0, [r2]
	add r1, r1, #0x800
...
func_ov30_02183904: ; 0x02183904
	stmdb sp!, {r3, r4, r5, lr}
	ldr r3, _02183964 ; =gActorManager
	add r2, r0, #0x84
	ldr r0, [r3]
	mov r5, r1
	add r1, r2, #0x800
...
_02183ab0:
	...
	blo _02183ab0
	ldr r1, [r6, #8]
	ldr r0, _02183b88 ; =gActorManager
	str r1, [sp, #0xc]
	ldr r4, [r6, #0xc]
	add r3, sp, #0xc
	ldr r0, [r0]
	...
	ldr r7, _02183b88 ; =gActorManager
	mov r5, r4
	mov r9, #0x2800
_02183b1c:
	ldr r1, [sp, #0x1c]
...
_02183bc8:
	...
	blo _02183bc8
	ldr r1, [r6, #8]
	ldr r0, _02183ca0 ; =gActorManager
	str r1, [sp, #0xc]
	ldr r4, [r6, #0xc]
	add r3, sp, #0xc
	ldr r0, [r0]
	...
	ldr r7, _02183ca0 ; =gActorManager
	mov r5, r4
	mov r9, #0x2800
_02183c34:
	ldr r1, [sp, #0x1c]
...
func_ov30_0218411c: ; 0x0218411c
	...
	cmp r0, #0
	ble _021841ec
	ldr r4, _02184300 ; =gActorManager
	mov r9, r8
	add r11, sp, #0
_02184170:
	ldr r2, [r10]
...
_021842d4:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.align 2, 0
_021842fc: .word gPlayerLink
_02184300: .word gActorManager
...
_02184404:
	...
	ldr r0, [r2, #4]
	str r0, [sp, #0x10]
	ldr r0, _0218454c ; =gActorManager
	ldr r0, [r0]
...
_02184564:
	...
	ldr r0, _0218463c ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	blx _ZN12ActorManager8GetActorEP8ActorRef
	ldr r1, [r5, #0x14]
...
_021846b0:
	...
	add r1, sp, #0x10
	str r0, [sp, #0x14]
	ldr r0, _02184730 ; =gActorManager
	ldr r0, [r0]
	blx _ZN12ActorManager8GetActorEP8ActorRef
	ldr r1, _02184720 ; =0x000012a4
	add r7, #8
...
_021848f4:
	...
	cmp r3, r0
	blo _021848f4
	ldr r0, _02185250 ; =gActorManager
	add r1, sp, #0x24
	ldr r0, [r0]
	add r2, sp, #0x530
	bl _ZN12ActorManager12FilterActorsEP15ActorFilterBaseP9ActorList
	...
	ldr r5, _02185250 ; =gActorManager
_02184940:
	ldr r1, [sp, #0x530]
	ldr r0, [r5]
	add r1, r1, r9
...
_02184e84:
	...
	ldr r6, _02185250 ; =gActorManager
	mov r11, r7
_02184ed4:
	ldr r1, [sp, #0x228]
	ldr r0, [r6]
