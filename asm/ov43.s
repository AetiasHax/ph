...
func_ov43_02189904: ; 0x02189904
	...
	ldr r0, _021899a0 ; =gActorManager
	str r1, [r4]
	ldr r1, [r0]
...
func_ov43_021899ac: ; 0x021899ac
	...
	ldr r0, _02189a50 ; =gActorManager
	str r1, [r4]
	ldr r1, [r0]
...
func_ov43_02189a5c: ; 0x02189a5c
	...
	ldr r0, _02189af8 ; =gActorManager
	str r1, [r4]
	ldr r1, [r0]
...
_02189ebc:
	...
	cmp r1, r0
	blo _02189ebc
	ldr r0, _02189f94 ; =gActorManager
	mov r7, #0
	...
	ldr r7, _02189f94 ; =gActorManager
	mov r5, r4
_02189f54:
	ldr r1, [sp]
	ldr r0, [r7]
...
_02189fb8:
	...
	cmp r1, r0
	blo _02189fb8
	ldr r0, _0218a0ec ; =gActorManager
	mov r4, #0
	...
	cmpgt r0, #0
	ble _0218a080
	ldr r8, _0218a0ec ; =gActorManager
	mov r6, r5
_0218a04c:
	ldr r1, [sp]
	ldr r0, [r8]
...
func_ov43_0218a86c: ; 0x0218a86c
	ldr ip, _0218a878 ; =_ZN11ItemManager21GetEquipItemUncheckedEi
	mov r0, #1
	bx ip
	.align 2, 0
_0218a878: .word _ZN11ItemManager21GetEquipItemUncheckedEi
...
func_ov43_0218b720: ; 0x0218b720
	...
	addhs sp, sp, #8
	ldmhsia sp!, {r4, pc}
	ldr r1, _0218b7b0 ; =gActorManager
	...
	addeq sp, sp, #8
	ldmeqia sp!, {r4, pc}
	ldr r0, _0218b7b0 ; =gActorManager
	add r1, sp, #0
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	str r0, [r4, #0x3bc]
...
_0218b820:
	...
	cmp r0, #0
	bne _0218b910
	ldr r1, _0218ba14 ; =gActorManager
	...
	cmp r1, r0
	beq _0218b8c8
	ldr r0, _0218ba14 ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	str r0, [r5, #0x3bc]
...
_0218ba78:
	...
	cmp r1, r0
	beq _0218bb0c
	ldr r0, _0218c97c ; =gActorManager
	add r1, r4, #0x3c4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
_0218d0e4:
	...
	addeq sp, sp, #0x1c
	ldmeqia sp!, {r3, r4, pc}
	ldr r0, _0218d198 ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	ldr r2, [r0, #4]
...
_0218d168:
	...
	ldmia sp!, {r3, r4, pc}
	.align 2, 0
_0218d198: .word gActorManager
_0218d19c: .word 0x504c444d
_0218d1a0: .word gPlayerLink
