...
_0216d860:
	...
	mov sb, #0
	ldr lr, _0216da9c ; =data_ov00_020e72f0
	add r8, sp, #0x40
...
_0216da9c: .word data_ov00_020e72f0
...
func_ov25_0216ecf4: ; 0x0216ecf4
	...
	mov r5, #0
	add r4, sp, #0x98
	ldr r7, _0216eed4 ; =data_ov00_020e72f0
	...
	str r2, [sp, #0x38]
	ldr r2, [r0, #8]
	ldr r1, _0216eedc ; =data_027e0fe4
	str r2, [sp, #0x28]
	ldr r5, [r0, #0xc]
	ldr r0, [r1]
	add r4, sp, #0x28
...
_0216eed4: .word data_ov00_020e72f0
...
_021700c0:
	...
	cmp r0, #0
	bgt _0217017c
	ldr r0, _021703ac ; =data_027e0fc8
	ldr r0, [r0]
	ldr r1, [r0]
	ldr r1, [r1, #0x84]
	blx r1
...
func_ov25_021703bc: ; 0x021703bc
	stmdb sp!, {r4, lr}
	sub sp, sp, #0xc0
	ldr r1, _02170d54 ; =data_027e0fc8
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x48
...
_02170a8c:
	...
	b _02170d10
_02170aa8:
	ldr r0, _02170d54 ; =data_027e0fc8
	add r1, r4, #0x48
	ldr r0, [r0]
	mov r2, #0x1000
...
func_ov25_0217135c: ; 0x0217135c
	stmdb sp!, {r3, lr}
	ldr r2, _02171384 ; =data_027e0fe4
	add r1, r0, #0x2dc
	ldr r0, [r2]
	add r1, r1, #0x400
	bl func_ov00_020c3674
...
func_ov25_02171508: ; 0x02171508
	...
	mov r2, r4
	bl func_ov00_020c4048
	ldr r0, _021715e8 ; =data_027e0fe4
	add r1, sp, #4
	ldr r0, [r0]
	bl func_ov00_020c3674
	cmp r0, #0
...
_0217210c:
	...
	add r0, r6, #0x48
	bl func_ov25_02171c2c
	ldr r0, _021721e0 ; =data_027e0fe4
	add r1, r6, #0x174
	ldr r0, [r0]
	bl func_ov00_020c3674
	mov r4, r0
...
func_ov25_0217345c: ; 0x0217345c
	stmdb sp!, {r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0xd4
	ldr r7, _02173580 ; =data_ov00_020e72f0
	mov r4, #0
	add r3, sp, #0xc0
	mvn r5, #0
...
_021734c4:
	...
	cmp r8, r0
	blo _021734c4
	ldr r0, _02173588 ; =data_027e0fe4
	add r1, sp, #0x8c
	ldr r0, [r0]
	add r2, sp, #0
	bl func_ov00_020c37ec
...
_02173580: .word data_ov00_020e72f0
...
func_ov25_02173728: ; 0x02173728
	stmdb sp!, {r3, r4, r5, r6, r7, r8, lr}
	sub sp, sp, #0x74
	ldr r1, _02173a3c ; =data_027e0fe4
	mvn r8, #0
	mov r4, r0
	mov r7, #0
	add r6, sp, #0x60
	ldr lr, _02173a40 ; =data_ov00_020e72f0
...
_021737e4:
	...
	cmp r0, #0
	ble _02173a30
	ldr r7, _02173a3c ; =data_027e0fe4
	add r6, sp, #0xc
_021737fc:
	ldr r0, [r7]
	mov r1, r6
...
_02173a40: .word data_ov00_020e72f0
...
_02174aa4:
	...
	mov r2, #1
	str r5, [sp, #0x318]
	ldr r3, _021750a4 ; =data_027e0fe4
	str r8, [sp, #0x2bc]
	add r5, sp, #0x13c
	strb r7, [sp, #0x31f]
	str r0, [sp, #0x240]
...
_02174d3c:
	...
	add r1, sp, #0x214
	mvn r3, #0
	ldr r6, _021750ac ; =data_ov00_020e72f0
...
_02174d9c:
	...
	cmp r7, r0
	blo _02174d9c
	ldr r0, _021750a4 ; =data_027e0fe4
	add r1, sp, #0x1e0
	ldr r0, [r0]
	add r2, sp, #0x154
	bl func_ov00_020c37ec
...
_021750ac: .word data_ov00_020e72f0
...
func_ov25_02175b08: ; 0x02175b08
	stmdb sp!, {r3, r4, r5, r6, r7, r8, lr}
	sub sp, sp, #0x74
	ldr r1, _02175c48 ; =data_027e0fe4
	mvn r8, #0
	mov r7, #0
	add r5, sp, #0x60
	mov r6, r0
	ldr lr, _02175c4c ; =data_ov00_020e72f0
	...
	cmpgt r0, #0
	ble _02175bfc
	ldr r7, _02175c48 ; =data_027e0fe4
	mov r5, r4
_02175bb8:
	ldr r1, [sp]
	ldr r0, [r7]
...
_02175bfc:
	ldr r0, [sp, #8]
	add r4, r6, #0x100
	ldr r5, _02175c48 ; =data_027e0fe4
	strh r0, [r4, #0x78]
	add r6, r6, #0x158
	mov r7, #0
_02175c14:
...
_02175c4c: .word data_ov00_020e72f0
...
func_ov25_02175d1c: ; 0x02175d1c
	stmdb sp!, {r4, r5, r6, lr}
	ldr r4, _02175d68 ; =data_027e0fe4
	add r6, r0, #0x158
	mov r5, #0
_02175d2c:
	ldr r0, [r4]
...
func_ov25_02175dbc: ; 0x02175dbc
	...
	ldr r5, _02175e78 ; =data_027e0fe4
	mov r8, #0
_02175e1c:
	ldr r1, [r6]
	ldmib r6, {r0, r2}
...
func_ov25_02175ff8: ; 0x02175ff8
	...
	mov r8, r0
	mov r6, #0
	ldr r4, _02176084 ; =data_027e0fe4
	mov r5, r6
	add r7, r8, #0x158
_02176010:
	ldr r0, [r4]
	...
	cmp r0, r6
	ldmia sp!, {r4, r5, r6, r7, r8, pc}
	ldr r5, _02176084 ; =data_027e0fe4
	strh r6, [r4, #0x78]
	add r6, r8, #0x158
	mov r7, #0
_02176054:
...
_0217613c:
	ldr r0, _0217633c ; =data_027e0fc8
	ldr r0, [r0]
	ldr r1, [r0]
	ldr r1, [r1, #0x80]
	blx r1
...
_021762d0:
	...
	add r7, r4, #0x158
	ldr r5, _02176368 ; =data_027e0fe4
	mov r6, #0
	add r4, r4, #0x100
_021762e4:
	ldr r0, [r5]
...
_02176510:
	...
	cmp r6, r0
	beq _02176554
	ldr r0, _02176960 ; =data_027e0fe4
	add r1, r4, #0x158
	ldr r0, [r0]
	add r1, r1, r6, lsl #3
	bl func_ov00_020c3674
...
func_ov25_02176d74: ; 0x02176d74
	ldr ip, _02176d7c ; =func_ov00_020c3180
	bx ip
	.align 2, 0
	arm_func_end func_ov25_02176d74
_02176d7c: .word func_ov00_020c3180
...
_02176ff8:
	cmp r1, #0xb
	blt _02177050
	ldr r0, _0217705c ; =data_027e0fe4
	ldr r0, [r0]
...
func_ov25_02177064: ; 0x02177064
	...
	addeq sp, sp, #0xc
	ldmia sp!, {r4, r5, pc}
	ldr r0, _021770e4 ; =data_027e0fe4
	ldrb r5, [r4, #0x15]
	ldrb lr, [r4, #0x14]
...
data_ov25_02179368: ; 0x02179368
	.byte 0x6d, 0x6f, 0x75, 0x74, 0x68, 0x00, 0x00, 0x00
...
data_ov25_021794f8: ; 0x021794f8
	.byte 0x63, 0x75, 0x62, 0x75, 0x73, 0x5f, 0x62, 0x65
	.byte 0x61, 0x6d, 0x00, 0x00
...
data_ov25_02179608: ; 0x02179608
	.byte 0x62, 0x6f, 0x73, 0x73, 0x5f, 0x70, 0x68, 0x61
	.byte 0x6e, 0x74, 0x6f, 0x6d, 0x00, 0x00, 0x00, 0x00
data_ov25_02179618: ; 0x02179618
	.byte 0x62, 0x6f, 0x64, 0x79, 0x00, 0x00, 0x00, 0x00
...
data_ov25_02179ba0: ; 0x02179ba0
	.byte 0xc4, 0x97, 0x17, 0x02
data_ov25_02179ba4: ; 0x02179ba4
	.byte 0x04, 0x98, 0x17, 0x02
data_ov25_02179ba8: ; 0x02179ba8
	.byte 0x44, 0x98, 0x17, 0x02
...
data_ov25_02179bb4: ; 0x02179bb4
	.byte 0xcc, 0x99, 0x17, 0x02
data_ov25_02179bb8: ; 0x02179bb8
	.byte 0x0c, 0x9a, 0x17, 0x02
data_ov25_02179bbc: ; 0x02179bbc
	.byte 0x4c, 0x9a, 0x17, 0x02
...
data_ov25_02179c68: ; 0x02179c68
	.byte 0xfc, 0x16, 0x17, 0x02
data_ov25_02179c6c: ; 0x02179c6c
	.byte 0x50, 0x16, 0x17, 0x02
...
data_ov25_02179d94: ; 0x02179d94
	.byte 0x43, 0x53, 0x30, 0x3a, 0x2f, 0x63, 0x75, 0x62, 0x75, 0x73, 0x2e, 0x6e
...
data_ov25_02179db0: ; 0x02179db0
	.byte 0x43, 0x53, 0x36, 0x3a, 0x2f, 0x63, 0x75, 0x62, 0x75, 0x73, 0x5f, 0x62, 0x65, 0x61, 0x6d, 0x2e
...
data_ov25_02179de0: ; 0x02179de0
	.byte 0xac, 0x1a, 0x17, 0x02
data_ov25_02179de4: ; 0x02179de4
	.byte 0xe8, 0x1b, 0x17, 0x02
...
data_ov25_02179f08: ; 0x02179f08
	.byte 0x60, 0x2c, 0x17, 0x02
data_ov25_02179f0c: ; 0x02179f0c
	.byte 0xb4, 0x2c, 0x17, 0x02
data_ov25_02179f10: ; 0x02179f10
	.byte 0x10, 0x2d, 0x17, 0x02
...
data_ov25_0217a024: ; 0x0217a024
	.byte 0xd4, 0x69, 0x17, 0x02
data_ov25_0217a028: ; 0x0217a028
	.byte 0xb8, 0x69, 0x17, 0x02
...
data_ov25_0217a2c0: ; 0x0217a2c0
	.byte 0x1c, 0x7d, 0x17, 0x02
data_ov25_0217a2c4: ; 0x0217a2c4
	.byte 0xcc, 0x7c, 0x17, 0x02
...
data_ov25_0217a5cc: ; 0x0217a5cc
	.byte 0x5c, 0x88, 0x17, 0x02
data_ov25_0217a5d0: ; 0x0217a5d0
	.byte 0x7c, 0x88, 0x17, 0x02
data_ov25_0217a5d4: ; 0x0217a5d4
	.byte 0xa4, 0x88, 0x17, 0x02
...
data_ov25_0217a708: ; 0x0217a708
	.byte 0xd8, 0x92, 0x17, 0x02
data_ov25_0217a70c: ; 0x0217a70c
	.byte 0x88, 0x92, 0x17, 0x02
...
data_ov25_0217a7c0: ; 0x0217a7c0
	.byte 0x5c, 0x8c, 0x17, 0x02
data_ov25_0217a7c4: ; 0x0217a7c4
	.byte 0xe8, 0x8e, 0x17, 0x02
data_ov25_0217a7c8: ; 0x0217a7c8
	.byte 0xac, 0x91, 0x17, 0x02
data_ov25_0217a7cc: ; 0x0217a7cc
	.byte 0xd8, 0x8e, 0x17, 0x02
