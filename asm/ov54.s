...
func_ov54_02198d68: ; 0x02198d68
	...
	ldr r0, _02198e00 ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl14GetFollowActorEv
	ldr r1, _02198e00 ; =gPlayerControl
	cmp r5, #0
	ldr r1, [r1]
	ldr r1, [r1, #0xa0]
	beq _02198dec
...
_0219919c:
	...
	bl _ZN13LinkStateBase18func_ov00_020a89bcEii
_021991a8:
	ldr r0, _021992c0 ; =gPlayerControl
	mov r2, #0
	ldr r1, [r0]
	strb r2, [r1, #0x7a]
	ldr r2, [r0]
...
_02199310:
	...
	ldr r0, _021997b4 ; =gPlayerControl
	mov r1, #1
	ldr r3, [r0]
	ldrb r2, [r3, #0x7b]
	strb r2, [r3, #0x79]
...
_02199788:
	bl func_ov54_02198efc
_0219978c:
	ldr r1, _021997b4 ; =gPlayerControl
	mov r0, r4
	ldr r1, [r1]
	ldrb r4, [r1, #0x7a]
	bl _ZN13LinkStateBase18func_ov00_020a8d40Ev
...
func_ov54_021997f0: ; 0x021997f0
	stmdb sp!, {r3, r4, lr}
	sub sp, sp, #0x1c
	ldr r0, _021998cc ; =gPlayerControl
	add r1, sp, #0
	ldr r0, [r0]
	mov r2, #0
	ldr r4, [r0, #0xa0]
