...
_0216e46c:
	...
	cmp r1, r0
	beq _0216e64c
	ldr r0, _0216e69c ; =gActorManager
	add r1, sp, #0x24
	ldr r0, [r0]
...
func_ov19_0216eda4: ; 0x0216eda4
	...
	ldr r0, _0216ee58 ; =gActorManager
	mvn r6, #0
...
func_ov19_02173cf4: ; 0x02173cf4
	stmdb sp!, {r4, lr}
	ldr r1, _02173d28 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	mov r1, #0
...
func_ov19_02173d2c: ; 0x02173d2c
	stmdb sp!, {r3, lr}
	ldr r0, _02173d50 ; =gActorManager
	mov r1, #0
	ldr r0, [r0]
	bl _ZN12ActorManager18func_ov00_020c3b2cEPi
	cmp r0, #0
...
func_ov19_0217416c: ; 0x0217416c
	...
	add r3, sp, #0xc
	bl func_ov00_020c4048
	ldr r0, _02174208 ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov19_021745b8: ; 0x021745b8
	...
	cmp r1, r0
	beq _02174604
	ldr r0, _02174784 ; =gActorManager
	add r1, r7, #0x34c
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
_02174604:
	ldr r1, _02174784 ; =gActorManager
...
_021747e4:
	...
	cmp r1, r0
	beq _02174824
	ldr r0, _02174874 ; =gActorManager
	add r1, r4, #0x34c
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
_02174910:
	...
	cmp r1, r0
	blo _02174910
	ldr r0, _021749e8 ; =gActorManager
	mov lr, #0
	...
	cmpgt r0, #0
	ble _021749dc
	ldr r4, _021749e8 ; =gActorManager
	mov r6, r5
_021749a4:
	ldr r1, [sp]
	ldr r0, [r4]
...
_02176008: .word _ZN9ActorTypeD1Ev
...
_02176058: .word _ZN9ActorTypeD1Ev
...
_02176098: .word _ZN9ActorTypeD1Ev
...
_021760d8: .word _ZN9ActorTypeD1Ev
...
_02176280: .word _ZN9ActorTypeD1Ev
...
_021762cc: .word _ZN9ActorTypeD1Ev
