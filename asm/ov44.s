...
func_ov44_0218a11c: ; 0x0218a11c
	...
	strb r1, [r4, r0]
	add r0, r4, #0
	blx _ZN5Actor18func_Ov00_020c1bfcEi
	cmp r0, #0
	beq _0218a176
	add r0, r4, #0
	blx _ZN5Actor4KillEv
	mov r0, #0
	pop {r4, pc}
_0218a176:
	add r0, r4, #0
...
func_ov44_0218a1a0: ; 0x0218a1a0
	stmdb sp!, {r4, lr}
	ldr r1, _0218a1c8 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
...
func_ov44_0218a1cc: ; 0x0218a1cc
	stmdb sp!, {r4, r5, lr}
	sub sp, sp, #0xc
	ldr r1, _0218a290 ; =gActorManager
	mov r5, r0
	ldr r0, [r1]
	add r1, r5, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov44_0218a294: ; 0x0218a294
	stmdb sp!, {r4, lr}
	ldr r1, _0218a2cc ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
_0218a4a4:
	...
	add r1, r5, #0xa
	str r1, [r4, #0x13c]
	ldr r0, _0218a600 ; =gActorManager
	add r1, r4, #0x318
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	add r1, r4, #0x318
...
_0218a66c: ; jump table
	...
	b _0218a8a8 ; case 3
_0218a67c:
	ldr r0, _0218a8f8 ; =gActorManager
	add r1, r4, #0x318
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	ldr r2, [r4, #0x138]
...
_0218a7fc:
	...
	cmp r0, #0
	beq _0218a8ec
	ldr r1, _0218a8f8 ; =gActorManager
...
func_ov44_0218af88: ; 0x0218af88
	...
	mov r2, r5
	bl func_ov00_020c4048
	ldr r0, _0218b038 ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov44_0218c5e0: ; 0x0218c5e0
	ldr ip, _0218c5ec ; =_ZN11ItemManager21GetEquipItemUncheckedEi
	mov r0, #1
	bx ip
	.align 2, 0
_0218c5ec: .word _ZN11ItemManager21GetEquipItemUncheckedEi
...
func_ov44_0218d724: ; 0x0218d724
	stmdb sp!, {r4, lr}
	sub sp, sp, #0x18
	ldr r1, _0218d7c8 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov44_0218d7d8: ; 0x0218d7d8
	stmdb sp!, {r3, r4, lr}
	sub sp, sp, #0xc
	ldr r1, _0218d874 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov44_0218d87c: ; 0x0218d87c
	stmdb sp!, {r3, r4, lr}
	sub sp, sp, #0xc
	ldr r1, _0218d8d8 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov44_0218d8e8: ; 0x0218d8e8
	stmdb sp!, {r4, lr}
	ldr r1, _0218d914 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov44_0218d91c: ; 0x0218d91c
	stmdb sp!, {r4, lr}
	ldr r1, _0218d944 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov44_0218d948: ; 0x0218d948
	stmdb sp!, {r3, r4, r5, lr}
	ldr r1, _0218d984 ; =gActorManager
	mov r5, r0
	ldr r0, [r1]
	add r1, r5, #0x318
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
_0218dbf8:
	...
	ldr r0, _0218dd68 ; =gActorManager
	add r1, r4, #0x320
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	movs r5, r0
...
_0218ddf4:
	...
	cmp r1, r0
	blt _0218e180
	ldr r1, _0218e18c ; =gActorManager
...
_0218e018:
	...
	cmp r1, r0, asr #12
	ble _0218e180
	ldr r0, _0218e18c ; =gActorManager
	add r1, r4, #0x318
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	mov r0, r4
...
func_ov44_0218e4a0: ; 0x0218e4a0
	...
	ldmneia sp!, {r4, r5, pc}
_0218e4ec:
	ldr ip, _0218e58c ; =_ZTV11FilterActor
	mov r2, #0
	add r1, sp, #0x38
	mvn r3, #0
	ldr r5, _0218e590 ; =0x5053424c
	ldr r0, _0218e594 ; =gActorManager
	str r5, [sp, #8]
	str ip, [sp, #4]
	str r3, [sp, #0xc]
	str r3, [sp, #0x10]
...
_0218e5b0:
	...
	cmp r2, r0
	blo _0218e5b0
	ldr r0, _0218e6a4 ; =gActorManager
	mov lr, #0
	ldr r7, _0218e6a8 ; =_ZTV11FilterActor
	add ip, sp, #0x40
...
_0218e684:
	...
	.align 2, 0
_0218e6a4: .word gActorManager
_0218e6a8: .word _ZTV11FilterActor
...
func_ov44_0218ea9c: ; 0x0218ea9c
	...
	ldr r0, _0218eba0 ; =data_ov44_0218feec
	ldr r1, _0218ebac ; =_ZN9ActorTypeD1Ev
...
_0218ebac: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218ebc8: ; 0x0218ebc8
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218ecc0 ; =data_ov44_0218ff18
	ldr r1, _0218eccc ; =_ZN9ActorTypeD1Ev
...
_0218eccc: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218ece4: ; 0x0218ece4
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218ed10 ; =data_ov44_0218ff44
	ldr r1, _0218ed1c ; =_ZN9ActorTypeD1Ev
...
_0218ed1c: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218ed24: ; 0x0218ed24
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218eee0 ; =data_ov44_0218ff64
	ldr r1, _0218eeec ; =_ZN9ActorTypeD1Ev
...
_0218eeec: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218ef0c: ; 0x0218ef0c
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218ef38 ; =data_ov44_0218ff9c
	ldr r1, _0218ef44 ; =_ZN9ActorTypeD1Ev
...
_0218ef44: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218ef4c: ; 0x0218ef4c
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218f048 ; =data_ov44_0218ffd0
	ldr r1, _0218f054 ; =_ZN9ActorTypeD1Ev
...
_0218f054: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218f070: ; 0x0218f070
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218f168 ; =data_ov44_0218fffc
	ldr r1, _0218f174 ; =_ZN9ActorTypeD1Ev
...
_0218f174: .word _ZN9ActorTypeD1Ev
...
func_ov44_0218f18c: ; 0x0218f18c
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _0218f1b8 ; =data_ov44_02190028
	ldr r1, _0218f1c4 ; =_ZN9ActorTypeD1Ev
...
_0218f1c4: .word _ZN9ActorTypeD1Ev
