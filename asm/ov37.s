...
func_ov37_0217c924: ; 0x0217c924
	...
	rsb r11, r0, #0
_0217c978:
	ldr r0, _0217cbe4 ; =gActorManager
	mov r1, r6
	ldr r0, [r0]
...
func_ov37_0217f8a4: ; 0x0217f8a4
	...
	add r0, r0, #0x29c
	mov r6, #0
	ldr r4, _0217f8e4 ; =gActorManager
	add r7, r0, #0x2c00
	mov r5, r6
_0217f8bc:
	ldr r0, [r4]
...
func_ov37_0217f980: ; 0x0217f980
	...
	add r0, r0, #0x334
	mov r6, #0
	ldr r4, _0217f9c0 ; =gActorManager
	add r7, r0, #0x2c00
	mov r5, r6
_0217f998:
	ldr r0, [r4]
...
func_ov37_0217f9c4: ; 0x0217f9c4
	...
	add r2, r4, #0x48
	bl func_ov00_020c4048
	ldr r0, _0217fa88 ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	add r1, r4, #0x2000
...
func_ov37_0217fab8: ; 0x0217fab8
	...
	add r3, sp, #0x10
	bl func_ov00_020c4048
	ldr r0, _0217fba8 ; =gActorManager
	add r1, r4, #0x2ec
	ldr r0, [r0]
	add r1, r1, #0x2c00
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov37_0217fbac: ; 0x0217fbac
	stmdb sp!, {r3, lr}
	ldr r2, _0217fbd4 ; =gActorManager
	add r1, r0, #0x2ec
	ldr r0, [r2]
	add r1, r1, #0x2c00
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov37_0217fbd8: ; 0x0217fbd8
	...
	add r3, sp, #0x10
	bl func_ov00_020c4048
	ldr r0, _0217fcb4 ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov37_02185300: ; 0x02185300
	ldr ip, _0218530c ; =_ZN11ItemManager21GetEquipItemUncheckedEi
	mov r0, #0
	bx ip
	.align 2, 0
_0218530c: .word _ZN11ItemManager21GetEquipItemUncheckedEi
...
func_ov37_02186184: ; 0x02186184
	...
	b _02186200
_021861b4:
	ldr r0, _0218620c ; =gActorManager
	mov r1, r2
	ldr r0, [r0]
...
func_ov37_021862d0: ; 0x021862d0
	...
	mov r4, r0
	ldr r0, _02186384 ; =gActorManager
	str r1, [r4]
	add r1, r4, #4
	ldr r0, [r0]
	add r1, r1, #0x400
...
func_ov37_02186390: ; 0x02186390
	...
	mov r4, r0
	ldr r0, _0218644c ; =gActorManager
	str r1, [r4]
	add r1, r4, #4
	ldr r0, [r0]
	add r1, r1, #0x400
...
func_ov37_02186458: ; 0x02186458
	...
	add r2, r4, #0x48
	bl func_ov00_020c4048
	ldr r0, _0218666c ; =gActorManager
	add r1, r4, #4
	ldr r0, [r0]
	add r1, r1, #0x400
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov37_02186720: ; 0x02186720
	...
	ldr r0, _02186850 ; =gActorManager
	add r1, r4, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	add r1, sp, #0x38
...
_021870d0:
	...
	ldr r0, _02187744 ; =gActorManager
	add r1, r5, #4
	ldr r0, [r0]
	add r1, r1, #0x400
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov37_021877c0: ; 0x021877c0
	...
	add r3, sp, #0x1c
	bl func_ov00_020c4048
	ldr r0, _021878a0 ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	movs ip, r0
