...
_01ffc998:
	...
	mov r1, r4
	bl func_01ffedf4
	ldr r1, _01ffd1d8 ; =unk_0207e968
	str r0, [sp, #0x2c]
	str r1, [sp]
	ldr r3, _01ffd1dc ; =unk_0207e96c
	add r0, sp, #0x284
	mov r1, #3
	mov r2, #0x10
	bl func_0204f614
...
_01ffda18:
	...
	mov r1, r5
	bl func_01ffedf4
	ldr r1, _01ffe1c0 ; =unk_0207e968
	mov r7, r0
	str r1, [sp]
	ldr r3, _01ffe1c4 ; =unk_0207e96c
	add r0, sp, #0x2ec
	mov r1, #3
	mov r2, #0x10
	bl func_0204f614
...
func_01fff510: ; 0x01fff510
	...
	mov r0, r6
	bl func_ov00_0208ee00
	ldr r1, _01fffb44 ; =unk_0207e968
	ldr r3, _01fffb48 ; =unk_0207e96c
	str r1, [sp]
	add r0, sp, #0x118
	mov r1, #3
	mov r2, #0x10
