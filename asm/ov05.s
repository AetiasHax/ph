...
_0210259c:
	...
	cmp r9, #2
	beq _02102608
	ldr r0, _021026e4 ; =gActorManager
	mov r1, r8
	ldr r0, [r0]
...
_021027d8:
	...
	ldr r0, _02102820 ; =gActorManager
	mov r1, r4
	ldr r0, [r0]
...
_02102978:
	...
	cmp r9, #2
	beq _021029b0
	ldr r0, _02102a64 ; =gActorManager
	mov r1, r8
	ldr r0, [r0]
...
func_ov05_021055e0: ; 0x021055e0
	...
	cmpne r1, #0
	beq _0210563c
	ldr r1, _02105668 ; =gPlayerControl
	ldr r1, [r1]
	ldrb r1, [r1, #0x79]
	cmp r1, #0
	bne _0210563c
...
_02105764:
	...
	ldmia sp!, {r3, r4, pc}
_02105770:
	ldr r1, _021057b0 ; =gPlayerControl
	ldr r1, [r1]
	ldrb r1, [r1, #0x79]
	cmp r1, #0
	bne _0210579c
...
func_ov05_02105850: ; 0x02105850
	...
	mov r1, #0
	ldr r0, _02105bf0 ; =gPlayerControl
	strb r1, [r6, #0x25]
	ldr r0, [r0]
...
_02105f4c:
	...
	addne sp, sp, #8
	ldmneia sp!, {r3, r4, r5, r6, r7, pc}
	ldr r0, _021065f0 ; =gPlayerControl
	ldr r0, [r0]
...
func_ov05_02106740: ; 0x02106740
	...
	ldr r1, _0210688c ; =gPlayerControl
	mov r0, r6
	ldr r7, [r1]
	bl _ZN13LinkStateBase14GetPlayerAngleEv
	add ip, sp, #4
...
func_ov05_02106a50: ; 0x02106a50
	...
	movne r0, #0
	ldmneia sp!, {r3, r4, r5, pc}
	ldr r0, _02106bb8 ; =gPlayerControl
	ldr r0, [r0]
	ldrb r1, [r0, #0x80]
	cmp r1, #0
	beq _02106a84
...
func_ov05_02106bbc: ; 0x02106bbc
	stmdb sp!, {r3, r4, r5, lr}
	ldr r2, _02106c6c ; =gPlayerControl
	mov r5, r0
	ldr r2, [r2]
	mov r4, r1
	ldrb r1, [r2, #0x79]
	...
	cmp r0, #0
	beq _02106c64
	ldr r0, _02106c6c ; =gPlayerControl
	add r1, sp, #0
	ldr r0, [r0]
...
_02106e0c:
	...
	cmp r0, r1
	blt _02106ee0
	ldr r0, _021071dc ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl18func_ov00_020b034cEv
...
_02107148:
	...
	bl func_ov00_0207c1b0
_02107188:
	ldr r1, _021071dc ; =gPlayerControl
	mov r0, r7
	ldr r4, [r1]
	bl _ZN13LinkStateBase12GetPlayerPosEv
	mov r1, r0
...
func_ov05_02107214: ; 0x02107214
	stmdb sp!, {r4, r5, lr}
	sub sp, sp, #0x1c
	ldr r1, _021073ac ; =gPlayerControl
	mov r4, r0
	ldr r0, [r1]
	mov r1, #1
...
func_ov05_021073b8: ; 0x021073b8
	stmdb sp!, {r3, r4, r5, r6, r7, lr}
	ldr r1, _0210759c ; =gPlayerControl
	mov r5, r0
	ldr r0, [r1]
	bl _ZN13PlayerControl18func_ov00_020b034cEv
	mov r4, r0
...
_021074c8:
	...
	ldr r0, _0210759c ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl13GetTouchAngleEv
	sub r0, r0, r6
	mov r0, r0, lsl #0x10
...
_02107664:
	...
	add r0, r2, r1
	str r0, [sp, #0x14]
	ldr r0, _02107864 ; =gActorManager
	mov r2, #0
	ldr r0, [r0]
	add r1, sp, #8
...
func_ov05_02107880: ; 0x02107880
	stmdb sp!, {r4, r5, r6, lr}
	ldr r1, _0210794c ; =gPlayerControl
	mov r5, r0
	ldr r0, [r1]
	mov r1, #1
	bl _ZN13PlayerControl14CheckTouchFastEj
...
_021079d0:
	...
	cmp r0, #0
	ble _02107a08
	ldr r0, _02107b64 ; =gPlayerControl
	ldr r0, [r0]
...
func_ov05_02107bd4: ; 0x02107bd4
	...
	ldr r6, _02107c88 ; =gActorManager
	add r9, r10, #0x44
	mov r8, #0
	mvn r5, #0
_02107bf4:
...
func_ov05_02107fc0: ; 0x02107fc0
	...
	ldr r4, _0210808c ; =gActorManager
	mov r9, r6
	add r8, r10, #0x44
	mvn r5, #0
_02107ff0:
...
func_ov05_02108094: ; 0x02108094
	...
	cmp r0, #0
	beq _021080ec
	ldr r0, _02108184 ; =gPlayerControl
	mov r1, #1
	ldr r0, [r0]
	bl _ZN13PlayerControl14CheckTouchFastEj
	cmp r0, #0
...
func_ov05_021089f4: ; 0x021089f4
	...
	mov r0, r4
	bl _ZN13LinkStateBase18func_ov00_020a82acEv
	ldr r0, _02108ce0 ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl9SetUnk_80Ev
	ldr r0, [r4, #0x74]
	cmp r0, #0x87
...
func_ov05_02108f38: ; 0x02108f38
	...
	cmp r1, r0
	ldmgeia sp!, {r4, pc}
	ldr r0, _02108f94 ; =gPlayerControl
	ldr r0, [r0]
...
func_ov05_0210ab1c: ; 0x0210ab1c
	...
	bl _ZN13LinkStateBase18func_ov00_020a8d40Ev
	mov r2, #1
	ldr r1, _0210ad68 ; =gActorManager
	strb r2, [r0, #0xba]
	ldr r0, [r1]
	add r1, r6, #0x10
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov05_0210ad88: ; 0x0210ad88
	...
	bl _ZN13LinkStateBase18func_ov00_020a8d40Ev
	mov r2, #0
	ldr r1, _0210b280 ; =gActorManager
	strb r2, [r0, #0xbc]
	ldr r0, [r1]
	add r1, r5, #0x10
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
_0210ae98:
	...
	ldr r1, _0210b294 ; =gPlayerControl
	mov r0, r5
	ldr r6, [r1]
	bl _ZN13LinkStateBase14GetPlayerAngleEv
	ldrsh r2, [r0]
...
func_ov05_0210b2a4: ; 0x0210b2a4
	...
	bl _ZN13LinkStateBase18func_ov00_020a8d40Ev
	mov r2, #0
	ldr r1, _0210b3b0 ; =gActorManager
	strb r2, [r0, #0xbc]
	ldr r0, [r1]
	add r1, r5, #0x10
	bl _ZN12ActorManager8GetActorEP8ActorRef
	...
	ldmia sp!, {r3, r4, r5, pc}
_0210b2fc:
	ldr r0, _0210b3b4 ; =gPlayerControl
	ldr r0, [r0]
...
_0210b3a0:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0210b3b0: .word gActorManager
_0210b3b4: .word gPlayerControl
...
_0210b474:
	...
	movne r4, #2
_0210b484:
	ldr r0, _0210b4f0 ; =gActorManager
	add r1, r6, #0x10
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	movs r2, r0
...
_0210b5f4:
	...
	ldmia sp!, {r3, r4, r5, r6, pc}
_0210b608:
	ldr r0, _0210b95c ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl9SetUnk_80Ev
	mov r0, r5
	bl _ZN13LinkStateBase18EquipItem_vfunc_28Ev
...
_0210b634:
	...
	mov r2, #0x8000
	rsb r2, r2, #0
	ldr r1, _0210b95c ; =gPlayerControl
	strh r2, [r0]
	ldr r0, [r1]
	bl _ZN13PlayerControl9SetUnk_80Ev
...
func_ov05_0210b9c4: ; 0x0210b9c4
	...
	ldmeqia sp!, {r4, r5, pc}
	ldr r0, [r4, #0x24]
	ldr r1, _0210ba8c ; =gActorManager
	str r0, [sp]
	ldr r2, [r4, #0x28]
...
_0210bb10:
	...
	addeq sp, sp, #0xc
	ldmeqia sp!, {r3, r4, pc}
	ldr r0, _0210bb4c ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl9SetUnk_80Ev
	mov r0, r4
	mov r1, #0
...
_0210bc18:
	...
	ldr r1, _0210bd60 ; =gPlayerControl
	mov r0, r5
	ldr r6, [r1]
	bl _ZN13LinkStateBase14GetPlayerAngleEv
	ldrsh r2, [r0]
...
_0210bdd8:
	...
	ldmia sp!, {r3, r4, r5, pc}
_0210bdec:
	ldr r0, _0210bf44 ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl16CheckNotTouchingEv
	cmp r0, #0
	bne _0210be14
...
_0210c004:
	...
	ldmia sp!, {r4, r5, r6, r7, r8, r9, pc}
_0210c040:
	ldr r0, _0210c200 ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl18func_ov00_020b034cEv
	cmp r0, #0xcd
	addle sp, sp, #0x14
	ldmleia sp!, {r4, r5, r6, r7, r8, r9, pc}
	ldr r1, _0210c200 ; =gPlayerControl
	mov r0, r4
	ldr r6, [r1]
	bl _ZN13LinkStateBase14GetPlayerAngleEv
	mov r5, r0
...
func_ov05_0210c20c: ; 0x0210c20c
	...
	cmp r0, #1
	bne _0210c2b4
	ldr r0, _0210c94c ; =gPlayerControl
	mov r2, #0
	ldr r0, [r0]
	add r1, sp, #8
	strb r2, [sp, #8]
...
_0210c88c:
	...
	str r1, [sp, #0x48]
	bl _ZN13LinkStateBase12GetPlayerPosEv
	ldr r1, _0210c94c ; =gPlayerControl
	ldr r2, [r0, #8]
	ldr r3, [r7, #0x2c]
	ldr r0, [r1]
	sub r1, r3, r2
...
func_ov05_0210e014: ; 0x0210e014
	ldr r0, _0210e020 ; =gPlayerLink
	ldr r0, [r0]
	bx lr
	.align 2, 0
_0210e020: .word gPlayerLink
...
func_ov05_0210e4e4: ; 0x0210e4e4
	...
	mov r6, r0
	bne _0210e52c
	ldr r0, _0210e878 ; =gPlayerControl
	mov r1, r2
	ldr r0, [r0]
	bl _ZN13PlayerControl18func_ov00_020af538Ev
	ldr r1, _0210e878 ; =gPlayerControl
	mov r0, r6
	ldr r4, [r1]
	bl _ZN14PlayerLinkBase19GetCurrentCharacterEv
	cmp r0, #1
...
_0210ecd0:
	...
	addlt sp, sp, #0x20
	ldmltia sp!, {r4, r5, r6, pc}
	ldr r0, _0210f688 ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl18func_ov00_020b034cEv
...
_0210eedc:
	...
	str r2, [r0, #0x1c]
	str r2, [r0, #0x20]
	ldr r1, _0210f688 ; =gPlayerControl
	str r2, [r0, #0x24]
	ldr r0, [r1]
	bl _ZN13PlayerControl14IsTouchingFastEv
	cmp r0, #0
...
func_ov05_0210f71c: ; 0x0210f71c
	ldr r0, _0210f750 ; =gPlayerControl
	ldr r0, [r0]
	ldrb r0, [r0, #0x7d]
	cmp r0, #0
	moveq r0, #1
...
_0210f884:
	cmp r9, #0
	ble _0210f89c
	ldr r0, _021101d8 ; =gPlayerControl
	ldr r0, [r0]
	bl _ZN13PlayerControl13GetTouchAngleEv
	mov r5, r0
_0210f89c:
...
_0211016c:
	...
	cmp r0, #0
	bne _021101a8
	ldr r1, _021101d8 ; =gPlayerControl
	mov r0, r10
	ldr r5, [r1]
	bl _ZN13LinkStateBase12GetPlayerPosEv
	mov r1, r0
...
_02111594:
	...
	cmp r0, #6
	beq _021116a4
	ldr r0, _02111a68 ; =gPlayerControl
	ldr r0, [r0]
...
_02111744:
	...
	bl _ZN13LinkStateBase14GetPlayerAngleEv
	ldrsh r2, [r0]
	ldr r0, _02111a7c ; =gActorManager
	add r1, sp, #0x24
	strh r2, [sp, #0x3c]
	ldr r0, [r0]
	mov r2, #0
...
func_ov05_02111a98: ; 0x02111a98
	stmdb sp!, {r4, lr}
	ldr r1, _02111af4 ; =gPlayerControl
	mov r4, r0
	ldr r0, [r1]
	bl _ZN13PlayerControl14GetFollowActorEv
	cmp r0, #0
	bne _02111aec
	ldr r0, _02111af4 ; =gPlayerControl
	ldr r0, [r0]
	ldr r0, [r0, #0xa0]
	cmp r0, #0
	bne _02111aec
