...
_0217cf9c: .word func_ov00_020a9b4c
...
_0217d164: .word func_ov00_020a9b4c
...
_0217d290: .word func_ov00_020a9b4c
...
func_ov36_0217d2a0: ; 0x0217d2a0
	...
	cmp r1, r0
	beq _0217d368
	ldr r0, _0217d68c ; =gActorManager
	add r1, sp, #0xc
	ldr r0, [r0]
...
_0217d68c: .word gActorManager
_0217d690: .word gVec3p_ZERO
...
_0217e2a4:
	...
	blx r3
_0217e2dc:
	ldr r1, _0217e3d4 ; =gActorManager
...
_0217e934:
	...
	cmp r1, r0
	beq _0217e970
	ldr r0, _0217eb40 ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	ldr r1, [r0, #4]
...
_0217eb3c: .word gPlayerLink
_0217eb40: .word gActorManager
...
func_ov36_0217f4f4: ; 0x0217f4f4
	...
	ldr r0, _0217f96c ; =gActorManager
	add r1, sp, #4
	ldr r0, [r0]
	add r2, sp, #0x70
	bl _ZN12ActorManager12FilterActorsEP15ActorFilterBaseP9ActorList
...
_02180f44:
	...
	cmp r1, r0
	beq _02181000
	ldr r0, _0218102c ; =gActorManager
	add r1, r5, #0x18
	ldr r0, [r0]
	add r1, r1, #0x800
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
_02182c70: .word gPlayerLink
_02182c74: .word data_ov00_020eec68
_02182c78: .word gVec3p_ZERO
...
func_ov36_02183504: ; 0x02183504
	...
	cmp r1, r0
	bne _0218354c
	ldr r1, _02183a08 ; =gActorManager
	...
	ldmia sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
_0218354c:
	ldr r0, _02183a08 ; =gActorManager
	add r1, r5, #0x810
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	movs r4, r0
...
func_ov36_02184938: ; 0x02184938
	...
	cmp r1, #0
	bne _021849c4
	ldr r1, _021849dc ; =gActorManager
	...
	ldr r0, _021849dc ; =gActorManager
	add r1, sp, #0
	ldr r0, [r0]
	add r2, sp, #0x10
	bl _ZN12ActorManager12FilterActorsEP15ActorFilterBaseP9ActorList
...
_021865a4:
	...
	add r0, r5, #0x170
	bl func_ov00_020b7e6c
	ldr r0, _02186640 ; =gActorManager
	add r1, r5, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
_02186bec: .word _ZN9ActorTypeD1Ev
...
_02186c2c: .word _ZN9ActorTypeD1Ev
...
data_ov36_02186d00: ; 0x02186d00
    .word func_ov36_0217f414 ; data_ov61_0217f414
...
data_ov36_02186d18: ; 0x02186d18
    .word func_ov36_0217d044
	.global data_ov36_02186d1c
data_ov36_02186d1c: ; 0x02186d1c
    .word func_ov36_0217d168 ; data_ov61_0217d168
...
data_ov36_02186dec: ; 0x02186dec
    .word func_ov36_0217cc98 ; func_ov37_0217cc98
	.global data_ov36_02186df0
data_ov36_02186df0: ; 0x02186df0
    .word func_ov36_02185fdc
