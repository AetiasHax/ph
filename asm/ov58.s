...
func_ov58_021992c4: ; 0x021992c4
	...
	ldr r2, _021993e8 ; =gMapManager
	mov r5, r0
	ldr r0, [r2]
	mov r4, r1
	bl _ZN10MapManager18func_ov00_0208499cEv
	cmp r0, #0
	beq _0219930c
...
_021994ba:
	...
	pop {r4, r5, r6, r7, pc}
_021994c2:
	ldr r0, _021997f4 ; =gMapManager
	add r1, sp, #0x1bc
	ldr r0, [r0]
	blx _ZN10MapManager18func_ov00_0208346cEP4AABB
	ldr r0, [r4]
	add r1, sp, #0x128
	str r0, [sp, #0x128]
	ldr r0, [r4, #4]
...
_02199502:
	...
	strb r3, [r2, #1]
	ldr r2, [r2]
	blx _ZN10MapManager18func_ov00_02083c7cEP5Vec3pi
	ldr r0, [r4, #4]
	str r0, [sp, #0x1b4]
	ldr r1, [r5, #0x18]
	cmp r1, #0
...
_02199796:
	...
	ldr r0, [r0]
	add r1, r1, r2
	blx _ZN10MapManager16MapData_vfunc_54Ev
	cmp r0, #0x19
	bne _021997ec
	ldr r1, [r5, #0x18]
	ldr r0, _021997f4 ; =gMapManager
...
_021997f4: .word gMapManager
_021997f8: .word gPlayerPos
...
_0219983e:
	...
	add r2, sp, #0x64
	str r0, [sp, #0xf4]
	ldr r0, _02199b44 ; =gMapManager
	add r3, sp, #0x17c
	ldr r0, [r0]
	str r6, [sp, #0xf0]
	blx _ZN10MapManager16MapData_vfunc_6cEv
	ldr r0, [sp, #0x17c]
	cmp r0, #0
	bne _02199862
	ldr r0, [sp, #0x184]
...
func_ov58_0219a5b8: ; 0x0219a5b8
	ldr ip, _0219a5c4 ; =_ZN11ItemManager21GetEquipItemUncheckedEi
	mov r0, #7
	bx ip
	.align 2, 0
_0219a5c4: .word _ZN11ItemManager21GetEquipItemUncheckedEi
