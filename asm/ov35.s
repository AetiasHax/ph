...
func_ov35_0217bf7c: ; 0x0217bf7c
	...
	mov r6, r0
	mov r4, #0
	ldr r8, _0217c094 ; =gActorManager
	str r1, [r6]
	add r5, r6, #0x238
	mov r9, r4
	mvn r7, #0
...
func_ov35_0217c0a4: ; 0x0217c0a4
	...
	mov r6, r0
	mov r4, #0
	ldr r8, _0217c1c4 ; =gActorManager
	str r1, [r6]
	add r5, r6, #0x238
	mov r9, r4
	mvn r7, #0
...
func_ov35_0217c1d4: ; 0x0217c1d4
	...
	sub sp, sp, #0x48
	ldr r1, _0217c498 ; =gActorManager
	mov r10, r0
	ldr r0, [r1]
	add r1, r10, #0x34
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
_0217c290:
	...
	ldr r8, _0217c498 ; =gActorManager
...
_0217c44c:
	...
	.align 2, 0
_0217c498: .word gActorManager
_0217c49c: .word 0xfffffe66
_0217c4a0: .word 0x000004cd
_0217c4a4: .word gVec3p_ZERO
...
_0217c958:
	...
	cmp r1, r0
	beq _0217c998
	ldr r0, _0217ca80 ; =gActorManager
	add r1, r7, #0x238
	ldr r0, [r0]
	add r1, r1, r2, lsl #3
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
func_ov35_0217cc78: ; 0x0217cc78
	...
	mov r6, r0
	ldr r7, _0217cce4 ; =gActorManager
	add r4, r6, #0x238
	mov r5, #0
	mvn r8, #0
_0217cc90:
...
func_ov35_0217da38: ; 0x0217da38
	...
	cmp r1, r0
	beq _0217da78
	ldr r0, _0217dab8 ; =gActorManager
	add r1, r4, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov35_0217dac0: ; 0x0217dac0
	...
	cmp r1, r0
	beq _0217db00
	ldr r0, _0217db48 ; =gActorManager
	add r1, r4, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov35_0217db50: ; 0x0217db50
	...
	cmp r1, r0
	beq _0217dc68
	ldr r0, _0217dc78 ; =gActorManager
	add r1, r4, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov35_0217dc7c: ; 0x0217dc7c
	...
	cmpne r1, r0
	beq _0217dcdc
	ldr r0, _0217dcec ; =gActorManager
	add r1, r5, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov35_0217dcf0: ; 0x0217dcf0
	...
	cmp r1, r0
	beq _0217dd30
	ldr r0, _0217e2c0 ; =gActorManager
	add r1, r5, #0x34
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	movs r4, r0
...
_0217ee08:
	...
	add r3, sp, #0x10
	bl func_ov00_020c4048
	ldr r0, _0217f054 ; =gActorManager
	add r1, sp, #8
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	cmp r0, #0
...
func_ov35_021849dc: ; 0x021849dc
	stmdb sp!, {r4, lr}
	ldr r1, _02184a94 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x34
	bl _ZN12ActorManager8GetActorEP8ActorRef
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_02184a94: .word gActorManager
_02184a98: .word gVec3p_ZERO
