...
func_ov50_02196d94: ; 0x02196d94
	...
	ldmia r0, {r0, r1, r2}
	stmia r4, {r0, r1, r2}
	ldr r0, _02196ed8 ; =gActorManager
	ldr r3, [sp, #0x24]
	ldr r0, [r0]
	add r1, sp, #0
	add r2, sp, #0x28
	...
	ldr r5, _02196ed8 ; =gActorManager
	add r10, sp, #0x34
	add r6, sp, #0x74
_02196e74:
	ldr r0, [r5]
...
func_ov50_02196ee4: ; 0x02196ee4
	...
	ldmia r0, {r0, r1, r2}
	stmia ip, {r0, r1, r2}
	ldr r0, _02196f78 ; =gActorManager
	ldr r3, [sp, #0x24]
	ldr r0, [r0]
	add r1, sp, #0
	mov r2, #0
...
func_ov50_021974e4: ; 0x021974e4
	stmdb sp!, {r4, lr}
	sub sp, sp, #0x18
	ldr r1, _0219755c ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	mov r1, r2
...
func_ov50_021979b4: ; 0x021979b4
	stmdb sp!, {r4, lr}
	sub sp, sp, #8
	ldr r1, _021979f8 ; =gActorManager
	mov r4, r0
	ldr r1, [r1]
...
func_ov50_02197a00: ; 0x02197a00
	stmdb sp!, {r4, lr}
	sub sp, sp, #0x18
	ldr r1, _02197ad0 ; =gActorManager
	mov r4, r0
	ldr r0, [r1]
	add r1, r4, #0x31c
	bl _ZN12ActorManager8GetActorEP8ActorRef
...
_021982d4:
	...
	cmp r0, #0x1e
	blt _02198340
	ldr r1, _02198590 ; =gActorManager
	...
	cmp r1, r0
	beq _02198340
	ldr r0, _02198590 ; =gActorManager
	add r1, sp, #0
	ldr r0, [r0]
	bl _ZN12ActorManager8GetActorEP8ActorRef
	mov r5, r0
...
_02198584: .word gSinCosTable
_02198588: .word 0x0000019a
_0219858c: .word gPlayerLink
_02198590: .word gActorManager
...
func_ov50_0219882c: ; 0x0219882c
	...
	ldr r0, _02198874 ; =data_ov50_02198cac
	ldr r1, _02198880 ; =_ZN9ActorTypeD1Ev
...
_02198880: .word _ZN9ActorTypeD1Ev
...
func_ov50_02198890: ; 0x02198890
	...
	bl _ZN9ActorTypeC1EjPFP5ActorvEPFivE
	ldr r0, _02198984 ; =data_ov50_02198ccc
	ldr r1, _02198990 ; =_ZN9ActorTypeD1Ev
...
_02198990: .word _ZN9ActorTypeD1Ev
