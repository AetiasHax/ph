...
_02189a74:
	...
	movne r0, #0x78
	str r0, [r7, #0x60]
	ldr r0, _02189b14 ; =gPlayerControl
	ldr r1, [r0]
...
func_ov42_02189b20: ; 0x02189b20
	...
	mov r4, r0
	mov r1, #0
	ldr r0, _02189b7c ; =gPlayerControl
	strb r1, [r4, #0x65]
	ldr r0, [r0]
	strb r1, [r0, #0x79]
	strb r1, [r0, #0x7b]
...
_02189be4:
	...
	mov r1, #0
	ldr r2, _02189cd4 ; =gPlayerControl
	strb r1, [r0, #0xb]
	ldr r2, [r2]
	mov r3, #1
...
func_ov42_02189ce8: ; 0x02189ce8
	ldr ip, _02189cf4 ; =_ZN11ItemManager21GetEquipItemUncheckedEi
	mov r0, #5
	bx ip
	.align 2, 0
_02189cf4: .word _ZN11ItemManager21GetEquipItemUncheckedEi
...
func_ov42_02189cf8: ; 0x02189cf8
	...
	mov r3, #1
	mov r2, #0x8000
	ldr r0, _02189e50 ; =gPlayerControl
	strb r3, [r4, #0x64]
	ldr r1, [r0]
	ldr r0, _02189e4c ; =gPlayerLink
	strb r3, [r1, #0x79]
...
func_ov42_02189e60: ; 0x02189e60
	stmdb sp!, {r3, lr}
	ldr r0, _02189e84 ; =gPlayerControl
	mov r1, #0
	ldr r0, [r0]
	strb r1, [r0, #0x79]
	strb r1, [r0, #0x7b]
