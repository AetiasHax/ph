...
func_ov59_02198f10: ; 0x02198f10
	...
	ldr r0, [r5, #0x20]
	cmp r0, #0
	ldr r0, _02198fa4 ; =gMapManager
	moveq r2, #1
	ldr r0, [r0]
	bl _ZN10MapManager18func_ov00_020858b0Ev
_02198f88:
	mov r0, #0
	strb r0, [r5, #0x1c]
	mov r0, #4
...
_021990c4:
	...
	cmp r1, r0
	bne _02199180
	ldr r0, _021992f8 ; =gPlayerControl
	ldr r2, [r0]
	ldr r1, [r2, #0xbc]
	str r1, [r6, #0x38]
	ldr r1, [r2, #0xc0]
...
func_ov59_0219930c: ; 0x0219930c
	...
	bx ip
	.align 2, 0
_02199318: .word _ZN11ItemManager21GetEquipItemUncheckedEi
...
_02199360:
	...
	blx r2
_021993b4:
	ldr r0, _0219a064 ; =gPlayerControl
	add r1, sp, #0xb0
	ldr r0, [r0]
	bl _ZN13PlayerControl14UpdateAimWorldEP5Vec3p
	add r0, sp, #0xb0
...
_02199968:
	...
	cmp r0, #0
	beq _02199b00
	ldr r1, _0219a064 ; =gPlayerControl
	ldr r1, [r1]
	add r1, r1, #0xc8
...
_0219a9f0: .word gPlayerPos
_0219a9f4: .word 0x00000666
_0219a9f8: .word gSinCosTable
_0219a9fc: .word gMapManager
...
_0219ad18:
	...
	stmia r6, {r0, r1, r2}
	ldr r1, [r3, #4]
	ldr r0, _0219af04 ; =gPlayerControl
	add r2, r1, #0x800
	ldr r0, [r0]
	add r1, sp, #0x44
	str r2, [sp, #0x54]
...
_0219aef8: .word gPlayerPos
_0219aefc: .word 0x0000ffff
_0219af00: .word gMapManager
_0219af04: .word gPlayerControl
...
_0219b0a4:
	...
	str r0, [r4, #0x160]
_0219b0bc:
	ldr r0, _0219b10c ; =gPlayerControl
	ldr r1, [r4, #0x158]
	ldr r2, [r0]
	str r1, [r2, #0xbc]
	ldr r0, [r4, #0x15c]
